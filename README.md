...
This repository contains a VGG-style 3D CNN architecture for Brain Age estimation from T1-weighted MRI and AI-Synthesized Cerebral Blood Volume data and two pretrained weight files (BrainAGE_T1_Model_Weights.pkl — T1-only model and BrainAGE_AICBV_Model_Weights.pkl — AICBV-enhanced model).
